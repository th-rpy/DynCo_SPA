                ...
                <section className="home-bg-color" id="home">
                                ...
                                <div className="container">
                                    ...
                                    <div className="row justify-content-center">
                                     ...
                                     <h2 className="mt-5 pt-5 home-title">
                                            
                                            <Typing speed={40} >
                                                We help startups launch their awesome website
                                                <Typing.Reset count={5} delay={800} />
                                                We are Creative
                                                <Typing.Reset count={10} delay={800} />
                                                We are Modern
                                            </Typing>
                                            ...
                                            <div className="mt-5">
                                                <Link to="/signup" className="btn btn-custom">Free Signup</Link>
                                            </div>
